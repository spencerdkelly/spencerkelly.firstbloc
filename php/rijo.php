      ...
      <div>
         ...
         <header class="work-header">
          <div class="work-header-title">
            <h1>Rijo</h1>
            <h3 class="lighter">Brand Identity Refresh</h3>
          </div>
          <div class="work-header-intro">
            <h2 class="small-title">Refreshing the brand identity for one of the UK's largest commercial coffee retailers.</h2>
          </div>
        </header>
        ...
        <div class="work-layout">
          ...
          <div class="work-row col-2">
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                  Rijo wanted to freshen up their brand identity whilst still retaining the existing brand essence.
                </p>
              </blockquote>
            </div>
            <div class="col">
          ...
          <div class="work-row col-2">
            ...
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                  The brand logo was given a fresh new look by removing the serifs and creating a better balance, allowing it to be placed inside a roundel.
                </p>
              </blockquote>
            </div>
          </div>
          ...
          <div class="work-row col-2">
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                 The new packaging design was inspired by the tribal markings of the indigenous peoples of Peru where most of the coffee beans are harvested.
                </p>
              </blockquote>
            </div>
            <div class="col">
          ...
          <div class="work-row col-2">
            ...
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                 The visual look of brand strapline was re-treated to have a raw, visceral feel allowing it to be used on its own without always accompanying the logo.
                </p>
              </blockquote>
            </div>
          </div>
          ...
          <div class="work-row col-2">
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                 The existing website was redesigned to make it easier for customers to browse the full range of commercial coffee machines, with clearer calls to action to book a demo. 
                </p>
              </blockquote>
            </div>
            <div class="col">
          ...
          <div class="work-row col-2">
            ...
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                 The new site was first created as a lo-fidelity wireframe in Figma, before moving it to a hi-fidelity prototype for the development team to build. 
                </p>
              </blockquote>
            </div>
          </div>
          ...
          <div class="work-row col-2">
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                 The overall brand design system included assets that could be composited and used in social media posts.
                </p>
              </blockquote>
            </div>
            <div class="col">
          ...
          <div class="work-row col-2">
            ...
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                 All assets were made available in Canva, enabling the client to make high impact, on-brand social posts in-house without the need for an external design agency.
                </p>
              </blockquote>
            </div>
          </div>
