      ...
      <div>
         ...
         <header class="work-header">
          <div class="work-header-title">
            <h1>Whitley Neill Gin</h1>
            <h3 class="lighter">Brand Repositioning & Ad Campaign</h3>
          </div>
          <div class="work-header-intro">
            <h2 class="small-title">Repositioning the UK's leading premium gin brand to include a wider range of flavours</h2>
          </div>
        </header>
        ...
        <div class="work-layout">
          <div class="work-row col-1">
            <div class="col">
              <div class="item-slider-container wn-grey pad-vert">
