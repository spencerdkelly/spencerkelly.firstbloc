      ...
      <div>
         ...
         <header class="work-header">
          <div class="work-header-title">
            <h1>Chu Lo</h1>
            <h3 class="lighter">Campaign Activation</h3>
          </div>
          <div class="work-header-intro">
            <h2 class="small-title">Campaign activation for a brand finalist from the BBC's Future Food Stars with Gordon Ramsey.</h2>
          </div>
        </header>
        ...
        <div class="work-layout">
          ...
          <div class="work-row col-2">
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                  Chu Lo drinks were looking to boost their profile with a social driven marketing campaign.
                </p>
              </blockquote>
            </div>
            <div class="col">
          ...
          <div class="work-row col-2">
            ...
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                  The campaign needed to have a super vibrant and eyecatching look that conveyed the drink's Japanese heritage and its sour flavour.
                </p>
              </blockquote>
            </div>
          </div>
          ...
          <div class="work-row col-2">
            <div class="col">
              <blockquote class="blockquote">
                <p class="work-quote">
                  A key target demographic for the brand was the UK gaming community, so much of the content referenced classic video games.
                </p>
              </blockquote>
            </div>
            <div class="col">
